...
## Step 13 — The register

The view every strip metric filters into. One row per requirement, carrying the instrument
it derives from — or `UNSOURCED` in red, because a blank cell reads as "not filled in yet"
while an explicit flag reads as a finding.
