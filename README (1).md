...
**Automate the process, never the judgement.** Status, routing, reminders, evidence
capture, escalation triggers — automate all of it. Whether a discrepancy is acceptable,
whether an alert is a true match, whether to accept a risk — those stay with a person who
holds the authority. The corollary: automation should make escalation *easier*, not rarer.
